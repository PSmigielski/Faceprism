 ...
 */
final class Version20211012102804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (co_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', co_author CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', co_post CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', co_reply_to CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', co_text VARCHAR(255) NOT NULL, co_created_at DATETIME NOT NULL, co_edited_at DATETIME DEFAULT NULL, co_replies_count INT NOT NULL, INDEX IDX_9474526C53DCFBED (co_author), INDEX IDX_9474526C1F1DDF02 (co_post), INDEX IDX_9474526CA824B40D (co_reply_to), PRIMARY KEY(co_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE follow (id INT AUTO_INCREMENT NOT NULL, fo_user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', fo_page_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_68344470AADBFB5 (fo_user_id), INDEX IDX_68344470A1850FC4 (fo_page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE page (pa_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', pa_name VARCHAR(255) NOT NULL, pa_bio VARCHAR(255) DEFAULT NULL, pa_follow_count INT NOT NULL, pa_profile_pic_url VARCHAR(255) NOT NULL, pa_banner_url VARCHAR(255) DEFAULT NULL, pa_email VARCHAR(255) DEFAULT NULL, pa_website VARCHAR(255) DEFAULT NULL, PRIMARY KEY(pa_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE page_moderation (pm_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', pm_page CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', pm_user CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', pm_page_role VARCHAR(50) NOT NULL, INDEX IDX_CB0A5B3A4A6322F7 (pm_page), INDEX IDX_CB0A5B3AD3FA429E (pm_user), PRIMARY KEY(pm_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post (po_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', po_author CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', po_page CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', po_created_at DATETIME NOT NULL, po_edited_at DATETIME DEFAULT NULL, po_text TEXT DEFAULT NULL, po_file_url VARCHAR(255) DEFAULT NULL, po_like_count INT NOT NULL, po_comment_count INT NOT NULL, INDEX IDX_5A8A6C8DC6918559 (po_author), INDEX IDX_5A8A6C8D7AB83FC (po_page), PRIMARY KEY(po_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE follow ADD CONSTRAINT FK_68344470AADBFB5 FOREIGN KEY (fo_user_id) REFERENCES user (us_id)');
        $this->addSql('ALTER TABLE follow ADD CONSTRAINT FK_68344470A1850FC4 FOREIGN KEY (fo_page_id) REFERENCES page (pa_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE follow DROP FOREIGN KEY FK_68344470A1850FC4');
        ...
        $this->addSql('ALTER TABLE follow DROP FOREIGN KEY FK_68344470AADBFB5');
